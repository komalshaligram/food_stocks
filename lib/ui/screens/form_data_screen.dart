                                  ...
                                  ? Column(
                                      children: [
                                        ...
                                        CustomFormField(
                                          ...
                                          fillColor: Colors.transparent,
                                          textInputAction: TextInputAction.next,
                                          validator: ownerName.isNotEmpty ? AppStrings.guaranteeName2String : '',
                                        ),
                                        7.height,
                                        CustomContainerWidget(
                                  ...
                                  debugPrint('state.haveMultiple :${state.haveMultiple }');
                                    if (state.business != AppLocalizations.of(context)!.type_of_business) {
                                      if (isValidIsraeliID(state.owner1israelIdController.text.toString().trim())) {
                                        if (state.haveMultiple &&(isValidIsraeliID(state.guarantee1idController.text.toString().trim()))) {
                                          if (state.haveMultiple && isValidIsraeliID(state.owner2israelIdController.text.toString().trim())) {
                                            if (state.haveMultiple && isValidIsraeliID(state.guarantee2idController.text.toString().trim())) {
