...
class FormDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => FormDataBloc()..add(FormDataEvent.getBusinessTypeEvent(context: context)), child: FormDataScreenWidget());
  }
}
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          12.width,
          Expanded(
            child: Text(l10n.agent_code_help_message,
                style: AppStyles.rkRegularTextStyle(
                    size: AppConstants.font_13, color: AppColors.blackColor.withValues(alpha: 0.7), fontWeight: FontWeight.w400)),
          ),
        ]),
        14.height,
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          height: 46,
          alignment: Alignment.center,
          decoration: BoxDecoration(borderRadius: BorderRadius.circular(_fieldRadius), border: Border.all(color: AppColors.mainColor, width: 1.4)),
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(Icons.headset_mic_rounded, size: 20, color: AppColors.mainColor),
            8.width,
            Text(l10n.agent_code_contact_support,
                style: AppStyles.rkRegularTextStyle(size: AppConstants.font_15, color: AppColors.mainColor, fontWeight: FontWeight.w600))
          ]),
        ),
      ),
    );
