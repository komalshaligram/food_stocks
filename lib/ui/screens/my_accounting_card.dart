...
class MyAccountingCardScreenContent extends StatelessWidget {
          ...
          return StatefulBuilder(builder: (context, setSheetState) {
            return Padding(
              padding: EdgeInsets.fromLTRB(
                  AppConstants.padding_20, AppConstants.padding_20, AppConstants.padding_20, MediaQuery.of(sheetContext).viewInsets.bottom + 20),
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text(isInvoicesTab ? AppLocalizations.of(context)!.invoice_date_range : AppLocalizations.of(context)!.refunds_date_range,
                ...
                Row(children: [
                  ...
                  5.width,
                  Expanded(
                    child: Text(AppLocalizations.of(context)!.to_date,
                        style: AppStyles.rkBoldTextStyle(size: AppConstants.font_14, color: AppColors.blackColor)),
                  ),
                ]),
                10.height,
                Row(children: [
                  Expanded(
                    child: InkWell(
                        onTap: () async {
                          final picked =
                              await showDatePicker(context: sheetContext, initialDate: tempFrom, firstDate: DateTime(2023), lastDate: DateTime.now());
                          if (picked != null) {
                            setSheetState(() {
                              tempFrom = picked;
                  ...
                  Expanded(
                    child: InkWell(
                        onTap: () async {
                          final picked =
                              await showDatePicker(context: sheetContext, initialDate: tempTo, firstDate: tempFrom, lastDate: DateTime.now());
                          if (picked != null) {
                ...
                Row(children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(AppLocalizations.of(context)!.closeText,
                            style: AppStyles.rkBoldTextStyle(size: AppConstants.smallFont, color: AppColors.redColor)),
                      ),
                    ),
                  ),
                  16.width,
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        decoration:
                            BoxDecoration(gradient: AppColors.appMainGradientColor, borderRadius: BorderRadius.circular(AppConstants.radius_10)),
                        alignment: Alignment.center,
  ...
  Widget _buildDateTile(String text, String hint) {
    ...
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text(isSelected ? text : hint,
            style: AppStyles.rkRegularTextStyle(size: AppConstants.smallFont, color: isSelected ? AppColors.blackColor : AppColors.greyColor)),
                      ...
                      : Container(
                          ...
                          child: IntrinsicWidth(
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              Text('${AppLocalizations.of(context)!.remaining_to_pay}: ',
                                  maxLines: 1,
                              ...
                              Directionality(
                                ...
                                child: Text(formatSignedNumber(state.clientBalance),
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    style: AppStyles.rkBoldTextStyle(
                                        size: AppConstants.smallFont, color: AppColors.whiteColor, fontWeight: FontWeight.w400)),
                          ...
                          GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  Text('${AppLocalizations.of(context)!.date_range}: $periodText',
  ...
  Widget _topSquareTabBar(BuildContext context, MyAccountingCardState state) {
    ...
    return Container(
      ...
      height: 50,
      decoration: BoxDecoration(
          gradient: AppColors.appMainGradientColor, color: AppColors.pageColor, borderRadius: BorderRadius.circular(AppConstants.radius_10)),
      child: Row(
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                    color: selected ? AppColors.whiteColor : Colors.transparent, borderRadius: BorderRadius.circular(AppConstants.radius_10)),
                child: Center(
  ...
  Widget _invoicesTab(BuildContext context, MyAccountingCardState state) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          Widget itemOne(MyAccountingCardState state) =>
                ...
                state.invoiceCardList[index].paymentMethod != null
                    ? Container(
                        ...
                        child: Text(
                            ...
                            style:
                                AppStyles.rkRegularTextStyle(size: AppConstants.font_14, color: AppColors.whiteColor, fontWeight: FontWeight.normal)),
                      )
                    : 0.width,
                state.invoiceCardList[index].paymentStatus != null
                    ? getPaymentStatusWidget(state.invoiceCardList[index].paymentStatus!, context)
                    : 0.width
              ]);

          Widget itemTwo(MyAccountingCardState state) =>
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    subTitleValueText(
                        context,
                        (state.invoiceCardList[index].invoiceDate ?? '').isNotEmpty
                            ? state.invoiceCardList[index].invoiceDate!.substring(0, 10)
                            : '---')
                  ]),
                ),
                Expanded(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  GestureDetector(
                      ...
                      child: state.invoiceCardList[index].orderNumber == null
                          ? const Text('---')
                          : invoiceOrderNumberWidget(state.invoiceCardList[index].orderNumber.toString())),
                ]),
              ),
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  ? GestureDetector(
                      onTap: () {
                        if (state.invoiceCardList[index].cardNumber != null && state.invoiceCardList[index].customerCreditcardToken != null) {
                          Navigator.pushNamed(context, RouteDefine.invoicePaymentScreen.name,
                              arguments: {AppStrings.invoiceData: state.invoiceCardList[index]}).then((value) {
                      ...
                      child: Container(
                        ...
                        decoration:
                            BoxDecoration(gradient: AppColors.appMainGradientColor, borderRadius: BorderRadius.circular(AppConstants.radius_10)),
                        child: Text(AppLocalizations.of(context)!.pay_invoice_text,
                            style:
                                AppStyles.rkRegularTextStyle(size: AppConstants.font_14, color: AppColors.whiteColor, fontWeight: FontWeight.normal)),
                      ),
                    )
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              state.refundInvoicesCardList[index].status.toString() != AppStrings.closedText ||
                      state.refundInvoicesCardList[index].refundedOnInvoice!.isNotEmpty
                  ? const DividerWidget(height: 20.0)
                  : const IgnorePointer(),
              (state.refundInvoicesCardList[index].refundedOnOrders!.isEmpty &&
                      state.refundInvoicesCardList[index].status.toString() != AppStrings.openText)
                  ? const IgnorePointer()
              ...
              (state.refundInvoicesCardList[index].refundedOnOrders!.isEmpty &&
                  ...
                  : _refundedOnOrderWidget(
                      state.refundInvoicesCardList, index, state.refundInvoicesCardList[index].invoiceNumber.toString(), state.statusList),
              state.refundInvoicesCardList[index].refundedOnInvoice!.isEmpty
                  ? const IgnorePointer()
                  : titleText(context, AppLocalizations.of(context)!.refunded_on_invoices),
              state.refundInvoicesCardList[index].refundedOnInvoice!.isEmpty
                  ? const IgnorePointer()
                  : _refundedOnInvoiceWidget(state.refundInvoicesCardList, index, state.refundInvoicesCardList[index].invoiceNumber.toString(),
                      state.refundInvoicesCardList[index].refundedOnInvoice!),
              const DividerWidget(height: 20.0),
              _totalRefundWidget(
                  context, state.refundInvoicesCardList[index].totalAmount.toString(), state.refundInvoicesCardList[index].remainingAmount.toString())
            ]),
          );
        });
  }

  Widget _refundInvoiceWidget(List<RefundInvoiceCommon> invoicesList, int index, BuildContext context, String invoiceNumber,
          List<StatusData> statusList, String invoiceDate, String invoiceStatus) =>
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
  ...
  Widget _refundedOnOrderWidget(List<RefundInvoiceCommon> invoicesList, int index, String invoiceNumber, List<StatusData> statusList) =>
      ListView.builder(
  ...
  Widget _refundedOnInvoiceWidget(
          List<RefundInvoiceCommon> invoicesList, int index, String invoiceNumber, List<RefundedInvoiceCommon> refundedOnInvoice) =>
      ListView.builder(
  ...
  Widget _totalRefundWidget(BuildContext context, String totalAmount, String remainingAmount) =>
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Column(
            crossAxisAlignment: CrossAxisAlignment.start,
