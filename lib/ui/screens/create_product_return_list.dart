...
class CreateProductReturnListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => CreateReturnBloc()
        ..add(CreateReturnEvent.getReturnListEvent(
            product: args ?? {}, context: context)),
...
class CreateProductReturnListWidget extends StatelessWidget {
            ...
            child: state.isShimmer
                ...
                : state.returnProductList.isNotEmpty
                    ? Column(mainAxisSize: MainAxisSize.max, children: [
                        ...
                        Padding(
                          padding:
                              const EdgeInsets.all(AppConstants.padding_15),
                          child: Column(
                              ...
                              children: [
                                !state.isFromPending
                                    ? CustomButtonWidget(
                                        ...
                                        isLoading: false,
                                        onPressed: () {
                                          bloc.add(CreateReturnEvent
                                              .navigateToAddProductEvent(
                                                  context: context));
                                        })
                                    : 0.height,
                                12.height,
  ...
  Widget returnListItem(
      ...
      required CreateReturnState state}) {
    return GestureDetector(
      onTap: () {
        context.read<CreateReturnBloc>().add(
            CreateReturnEvent.detailReturnEvent(
              ...
              state.returnProductList[index].productImg!.isNotEmpty
                  ? Image.network(
                      ...
                      return imageNotAvailableWidget(
                          AppConstants.containerHeight_100);
                    })
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        getLocalizedReason(
                            apiReason:
                                state.returnProductList[index].reasonToReturn ??
                                    '',
                            context: context),
                        style: AppStyles.rkRegularTextStyle(
                            size: AppConstants.font_14),
