                          ...
                          child: AnimationLimiter(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => AnimationConfiguration.staggeredList(
                                ...
                                position: index,
                                child: SlideAnimation(verticalOffset: 44.0, child: FadeInAnimation(child: returnListItem(index: index, context: context, state: state))),
                              ),
                            ),
                          ),
                        ),
  ...
  Widget returnListItem({required int index, required BuildContext context, required CreateReturnState state}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
          state.returnProductList[index].productImg!.isNotEmpty
              ? Image.network(state.returnProductList[index].productImg ?? '', width: 100, height: 100, fit: BoxFit.contain, loadingBuilder: (context, child, loadingProgress) {
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(state.returnProductList[index].productName ?? '', style: AppStyles.rkBoldTextStyle(size: AppConstants.smallFont), maxLines: 2, overflow: TextOverflow.ellipsis),
              3.height,
