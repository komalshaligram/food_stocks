...
class _ClientFormDetailsScreenWidgetState extends State<ClientFormDetailsScreenWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ClientFormDetailsBloc, ClientFormDetailsState>(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Align(
                ...
                child: Text(
                  AppLocalizations.of(context)!.client_info,
                            ...
                            children: [
                              ...
                              CommonDropDownButton(
                                  ...
                                  onChanged: (newBusiness) {
                                    bloc.add(ClientFormDetailsEvent.selectBusinessTypeEvent(
                              ...
                              7.height,
                              CustomContainerWidget(
                                name: AppLocalizations.of(context)!.owner1_sign,
                                star: '',
                              ),
                              Row(
                                children: [
                              ...
                              7.height,
                              CustomContainerWidget(
                                name: AppLocalizations.of(context)!.owner2_sign,
                                star: '',
                              ),
                              Row(
                                children: [
                              ...
                              7.height,
                              CustomContainerWidget(
                                name: AppLocalizations.of(context)!.guarantee1_sign,
                                star: '',
                              ),
                              Row(
                                children: [
                              ...
                              7.height,
                              CustomContainerWidget(
                                name: AppLocalizations.of(context)!.guarantee2_sign,
                                star: '',
                              ),
                              Row(
                                children: [
