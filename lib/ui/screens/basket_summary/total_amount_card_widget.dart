...
Widget totalAmountCard(
    BasketSummaryState state, BuildContext context, int index) {
  ...
  final double totalAmount =
      double.tryParse(state.tempList[index].totalAmount.toString()) ?? 0;
...
Widget basketRow(String title, String amount,
    {bool isTitle = false, double fontSize = 15}) {
