...
class CompanyProductsScreenWidget extends StatelessWidget {
  const CompanyProductsScreenWidget(
            ...
            return Scaffold(
              ...
              appBar: PreferredSize(
                ...
                child: CommonAppBar(
                  ...
                  title: state.productList.isNotEmpty
                      ? state.productList.elementAt(0).brandId ?? ''
                      : companyName ?? '',
                  ...
                  trailingWidget: GestureDetector(
                      onTap: () {
                        context
                            ...
                            .add(const CompanyProductsEvent.getGridListView());
                      },
                      child: Icon(state.isCompanyProductGrid
                          ? Icons.list
                          : Icons.grid_view)),
                ),
              ),
                              ...
                              child: noDataWidget(
                                ...
                                footer: CustomFooter(
                                  builder: (context, mode) => (state
                                      .isCompanyProductGrid &&
                                      !state.isShimmering &&
                                      state.isRefreshingProduct)
                                      ? const SupplierProductsScreenShimmerWidget()
                                      : (!state.isCompanyProductGrid &&
                                      !state.isShimmering &&
                                      state.isRefreshingProduct)
                                ...
                                onRefresh: () {
                                  ...
                                  context
                                      .read<CompanyProductsBloc>()
                                      .add(const CompanyProductsEvent
  ...
  // Categories of this brand (leading "All", selected by default). Tapping one
  // filters the products and reveals the sub-category row beneath.
  ...
  void _onCategoryTap(BuildContext context, String categoryId) {
    context.read<CompanyProductsBloc>().add(
        CompanyProductsEvent.selectCategoryEvent(
  ...
  void _onSubCategoryTap(BuildContext context, String subCategoryId) {
    context.read<CompanyProductsBloc>().add(
        CompanyProductsEvent.selectSubCategoryEvent(
  ...
  void handleIncrease(
      BuildContext context, CompanyProductsState state, int index) {
    ...
    if (minQty <= stock.quantity + 1) {
      context
          .read<CompanyProductsBloc>()
          .add(CompanyProductsEvent.increaseListQuantityOfProduct(
        context: context,
        productListIndex: 1,
      ...
      context
          .read<CompanyProductsBloc>()
          .add(CompanyProductsEvent.addToCartListProductEvent(
        context: context,
  ...
  void handleDecrease(
    ...
    if (minQty <= stock.quantity - 1) {
      context
          .read<CompanyProductsBloc>()
          .add(CompanyProductsEvent.decreaseListQuantityOfProduct(
        context: context,
        productListIndex: 1,
        productStockUpdateIndex: index,
        productSupplierIds: product.supplierId.toString(),
  ...
  void updateQty(BuildContext context, CompanyProductsState state, int index) {
    ...
    context
        .read<CompanyProductsBloc>()
        .add(CompanyProductsEvent.updateListQuantityOfProduct(
      context: context,
  ...
  Widget gridViewWidget(BuildContext context, CompanyProductsState state) =>
      GridView.builder(
  ...
  Widget listViewWidget(BuildContext context, CompanyProductsState state) =>
      ListView.builder(
          itemCount: state.productList.length,
          shrinkWrap: true,
          physics: const ClampingScrollPhysics(),
  ...
  Widget searchWidget(BuildContext context, CompanyProductsBloc bloc,
      CompanyProductsState state) =>
      CommonSearchWidget(
          onCloseTap: () {
              ...
              itemBuilder: (listViewContext, index) {
                return SearchItemWidget(
                    ...
                    onTap: () async {
                      ...
                      bloc.add(const CompanyProductsEvent
  ...
  void showProductDetails({
    ...
    context
        .read<CompanyProductsBloc>()
        .add(CompanyProductsEvent.getProductDetailsEvent(
      context: context,
      productId: productId,
            ...
            child: DraggableScrollableSheet(
                ...
                builder:
                  ...
                  return BlocProvider.value(
                    ...
                    child:
                    BlocBuilder<CompanyProductsBloc, CompanyProductsState>(
              ...
              builder: (context1, state) {
                ...
                return CustomDialog(
                    ...
                    negativeOnTap: () async {
                      ...
                      bloc.add(CompanyProductsEvent.addToCartProductEvent(
  ...
  Widget floatingButtonWidget(
      BuildContext context, CompanyProductsState state) =>
