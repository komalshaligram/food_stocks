                    ...
                    child: Stack(children: [
                      Container(
                          ...
                          child: state.message.message?.messageImage != null && state.message.message?.messageImage != ''
                              ? Image.network('${AppUrlEndPoints.baseFileUrl}${state.message.message?.messageImage ?? ''}',
                        ...
                        Container(
                          ...
                          child: Container(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(children: [
                                Expanded(
                                  child: Text(state.message.message?.title ?? '',
                                      style: AppStyles.rkRegularTextStyle(
                                          size: AppConstants.smallFont, color: AppColors.blackColor, fontWeight: FontWeight.w500)),
                                ),
                                10.width,
                                Text((state.message.createdAt ?? '').split(" ").first.toString(),
                                    style: AppStyles.rkRegularTextStyle(
                              ...
                              Padding(
                                ...
                                child: Text(parse(state.message.message?.summary ?? '').body?.text ?? '',
  ...
  void navigationToScreen({required String mainPage, required String subPage, required String id}) {
    if (subPage == '') {
      ...
      if (mainPage == 'returnScreen') {
        Navigator.pushNamed(navigatorKey.currentState!.context, RouteDefine.returnListScreen.name,
      ...
      if (subPage == 'companyProductsScreen') {
        ...
        Navigator.pushNamed(navigatorKey.currentState!.context, RouteDefine.storeCategoryScreen.name,
            arguments: {AppStrings.companyIdString: id, AppStrings.isSubCategory: 'false'});
