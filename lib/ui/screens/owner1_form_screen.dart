...
class _Owner1FormScreenWidgetState extends State<Owner1FormScreenWidget> {
          ...
          body: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                ...
                if (state.haveMultiple) ...[16.height, _buildGuarantorCard(context, state)],
                24.height,
                CustomButtonWidget(
  ...
  Widget _buildGuarantorCard(BuildContext context, Owner1FormState state) {
    return _buildFormCard(
      ...
      _buildFieldLabel(context, AppLocalizations.of(context)!.full_name),
      _buildTextField(
          context: context, controller: state.guarantee1NameController, keyboardType: TextInputType.text, validator: AppStrings.guaranteeNameString),
      14.height,
      _buildFieldLabel(context, AppLocalizations.of(context)!.israel_id),
      _buildTextField(
          context: context,
      ...
      _buildTextField(
          context: context, controller: state.guarantee1addressController, keyboardType: TextInputType.text, validator: AppStrings.addressValString),
      14.height,
...
class _SectionDivider extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Padding(padding: const EdgeInsets.symmetric(vertical: 16), child: Divider(color: AppColors.borderColor, height: 1));
  }
}
