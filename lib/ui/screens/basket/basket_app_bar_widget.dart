...
Widget appBarWidget(BuildContext context, BasketState state) => state.basketProductList.isNotEmpty
    ? Container(
        ...
        child: Row(children: [
          ...
          Expanded(
            child: Center(
              child: Text(AppLocalizations.of(context)!.my_basket,
...
void deleteDialog(
    {required BuildContext context, required String updateClearString, required String cartProductId, required int listIndex, double? totalAmount}) {
