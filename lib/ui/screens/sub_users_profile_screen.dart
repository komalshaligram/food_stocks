                                      ...
                                      if (isValidIsraeliID(state.israelIdController.text.toString().trim())) {
                                        if (_formKey.currentState!.validate()) {
                                          if (!state.isUpdate && !state.isEnable) {
                                            bloc.add(SubUsersProfileEvent.createSubUserEvent(
                                              context: context,
                                            ));
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                title,
                style: AppStyles.rkRegularTextStyle(size: AppConstants.smallFont, color: isDelete ? AppColors.redColor : AppColors.blackColor),
              ),
              Icon(
