...
class _SubUserProfileScreenWidgetState extends State<SubUserProfileScreenWidget> {
              ...
              : SingleChildScrollView(
                  ...
                  child: Form(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                      ...
                      if (state.isUpdate || state.isEnable) ...[24.height, _buildSaveButton(context, bloc, state)],
                      if (state.isEnable) ...[20.height, _buildPermissionsGroup(context, state), 20.height, _buildDeleteButton(context, bloc, state)]
                    ]),
                  ),
                ),
  ...
  Widget _buildPermissionsGroup(BuildContext context, SubUsersProfileState state) {
    ...
    return _buildFormCard(child: Column(children: _intersperseDividers(tiles)));
  }
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(AppLocalizations.of(context)!.delete_sub_user_account,
              style: AppStyles.rkRegularTextStyle(
  ...
  void deleteConfirmDialog(
      {required SubUsersProfileBloc bloc, required BuildContext context, required String directionality, required bool isDeleteProcess}) {
    showDialog(
        context: context,
        builder: (context1) {
