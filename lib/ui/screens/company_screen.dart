...
class CompanyScreenWidget extends StatelessWidget {
              ...
              child: Column(children: [
                state.isShimmering
                    ...
                    : state.companiesList.isEmpty
                        ? noDataWithEmpty(AppLocalizations.of(context)!.companies_not_available, context)
                        : GridView.builder(
                            shrinkWrap: true,
  ...
  Widget buildCompanyListItem(
      {required int index, required String companyLogo, required String companyName, required BuildContext context, required void Function() onTap}) {
    return Container(
