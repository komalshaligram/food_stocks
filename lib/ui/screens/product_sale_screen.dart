  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: ProductSaleScreenWidget(
          saleProductId: args?[AppStrings.companyIdString] ?? ''),
    );
  }
}
...
class ProductSaleScreenWidget extends StatelessWidget {
              ...
              trailingWidget: GestureDetector(
                  onTap: () {
                    context
                        ...
                        .add(const ProductSaleEvent.getGridListView());
                  },
                  ...
                  child: SmartRefresher(
                    ...
                    onRefresh: () {
                      context.read<ProductSaleBloc>().add(
                          ProductSaleEvent.refreshListEvent(context: context));
                      context.read<ProductSaleBloc>().add(
                          const ProductSaleEvent.getPreferencesDataEvent());
                    },
  ...
  void _updateQuantity(
      ...
      required ProductSaleState state,
      required int index}) {
    context
        .read<ProductSaleBloc>()
        .add(ProductSaleEvent.updateListQuantityOfProduct(
          context: context,
  ...
  void _addToCart(
    ...
    context
        .read<ProductSaleBloc>()
        .add(ProductSaleEvent.addToCartListProductEvent(
          context: context,
  ...
  void _increaseQuantity(
    ...
    if (minQty <= quantity + 1) {
      context
          .read<ProductSaleBloc>()
          .add(ProductSaleEvent.increaseListQuantityOfProduct(
            context: context,
            productListIndex: 1,
            productStockUpdateIndex: index,
  ...
  void _decreaseQuantity(
    ...
    if (minQty <= quantity - 1) {
      context
          .read<ProductSaleBloc>()
          .add(ProductSaleEvent.decreaseListQuantityOfProduct(
            context: context,
            productListIndex: 1,
            productStockUpdateIndex: index,
            productSupplierIds: product.supplierId.toString(),
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return CommonSaleListView(
              ...
              productName: productSaleData.productName ?? '',
              price: double.tryParse(productSaleData.productPrice.toString()) ??
                  0.0,
              quantity: productStockData.quantity,
              minQuantity: productSaleData.sale?.saleMinQuantity,
              maxQuantity: productSaleData.sale?.saleMaxQuantity,
                            ...
                            : SingleChildScrollView(
                                ...
                                child: Column(children: [
                                  CommonProductDetailsWidget(
                                      ...
                                      addToOrderTap: () {
                                        if (int.parse(state.productDetails.first
                                      ...
                                      productUnitPrice: double.parse(state
                                          ...
                                          '0'),
                                      scaleType:
                                          state.productDetails.first.scaleType,
                                      productImages: [
                                  ...
                                  state.isRelatedShimmering
                                      ...
                                      : state.relatedProductList.isEmpty
                                          ? 0.width
                                          : relatedProductWidget(context1,
                                              state.relatedProductList, context,
                                              productStockList:
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context2, i) {
                return CommonProductSaleItemWidget(
                    ...
                    isGuestUser:
                        context.read<ProductSaleBloc>().state.isGuestUser,
              ...
              child: BlocBuilder<ProductSaleBloc, ProductSaleState>(
                ...
                return CustomDialog(
                    ...
                    negativeOnTap: () async {
                      ...
                      bloc.add(ProductSaleEvent.addToCartProductEvent(
                          context: context, productId: productId));
                    },
                    positiveOnTap: () async {
                      Navigator.pop(context);
                      bloc.add(
                          ProductSaleEvent.getCartCountEvent(context: context));
                    });
              }),
            ));
  }
