...
class ProductSaleScreenWidget extends StatelessWidget {
                      ...
                      child: Column(children: [
                        state.isShimmering
                            ...
                            : state.productSalesList.isEmpty
                                ? noDataWithEmpty(AppLocalizations.of(context)!.currently_products_are_not_on_sale, context)
                                : state.isGridView
  ...
  void showProductDetails(
      ...
      required int productListIndex}) async {
    context.read<ProductSaleBloc>().add(
        ProductSaleEvent.getProductDetailsEvent(context: context, productId: productId, isBarcode: isBarcode, productListIndex: productListIndex));
                                ...
                                child: Column(children: [
                                  CommonProductDetailsWidget(
                                      ...
                                      addToOrderTap: () {
                                        ...
                                        if (!isMixedSale &&
                                          ...
                                          context
                                              ...
                                              .add(ProductSaleEvent.addToCartProductEvent(context: context1, productId: productId));
                                        } else {
                                      ...
                                      onQuantityChanged: (quantity) {
                                        context
                                            .read<ProductSaleBloc>()
                                            .add(ProductSaleEvent.updateQuantityOfProduct(context: context1, quantity: quantity));
                                      },
  ...
  //                     isGuestUser: context.read<ProductSaleBloc>().state.isGuestUser,
  //                     onGuestLoginRequired: () => Navigator.pushNamed(context, RouteDefine.connectScreen.name),
  //                     height: AppConstants.salesProductItemHeight,
  ...
  void showMinMaxQtyConfirmDialog(
      ...
      int? initialQuantity}) {
    final stockState = context.read<ProductSaleBloc>().state;
  ...
  Future<void> _openSalePromotionSheet(BuildContext context, String productId, {int? initialQuantity, bool closeParentBeforeOpen = false}) async {
    ...
    if (!context.mounted) return;
    bloc.add(ProductSaleEvent.applyCartQuantitiesEvent(cartQuantities: cartMap));
