  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ReturnBloc()
        ..add(ReturnEvent.getArgumentEvent(context: context, list: args ?? {})),
...
class ScanReturnProduct extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<ReturnBloc, ReturnState>(builder: (context, state) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          _scannerSection(context, bloc),
          _bottomSection(context, state, bloc)
        ]);
      }),
    );
  }
  ...
  Widget _bottomSection(
      BuildContext context, ReturnState state, ReturnBloc bloc) {
    return Container(
      ...
      child: Column(
          ...
          children: [
            ...
            CustomButtonWidget(
              ...
              onPressed: () {
                bloc.add(ReturnEvent.scanProductEvent(
                    context: context, barCode: state.barCodeController.text));
              },
