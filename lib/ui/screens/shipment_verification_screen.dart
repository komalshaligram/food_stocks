  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: ShipmentVerificationScreenWidget(
          ...
          isBasket: args?[AppStrings.isFromBasketScreen]),
    );
  }
}
...
class ShipmentVerificationScreenWidget extends StatefulWidget {
  ...
  final String? status;
  final bool? isBasket;
  const ShipmentVerificationScreenWidget(
      {required this.args,
      super.key,
  ...
  @override
  State<ShipmentVerificationScreenWidget> createState() =>
      _ShipmentVerificationScreenWidgetState();
}

class _ShipmentVerificationScreenWidgetState
    extends State<ShipmentVerificationScreenWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ShipmentVerificationBloc, ShipmentVerificationState>(
      ...
      final availableQty =
          widget.args?[AppStrings.availableSurfaceQuantityToReturn] ?? 0;
            ...
            body: SafeArea(
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsets.only(bottom: AppConstants.padding_50),
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            TextSpan(
                                              text:
                                                  '${' : '}${widget.args?[AppStrings.supplierOrderNumberString] ?? ''}',
                                              style:
                                                  AppStyles.rkRegularTextStyle(
                                                      color:
                                                          AppColors.blackColor,
                ...
                child: CustomButtonWidget(
                  ...
                  onPressed: state.isLoading
                      ...
                      : () async {
                          ...
                          final signData = await signImage.toByteData(
                              format: ui.ImageByteFormat.png);
                          final signBytes = signData!.buffer.asUint8List();
                          final dir =
                              (await getApplicationDocumentsDirectory()).path;
                          final signFile = await File('$dir/sign.png')
                              .writeAsBytes(signBytes);
                          final driverImage = await driverSignatureGlobalKey
                              .currentState!
                              .toImage();
                          final driverData = await driverImage.toByteData(
                              format: ui.ImageByteFormat.png);
                          final driverBytes = driverData!.buffer.asUint8List();
                          final driverFile = await File('$dir/driver_sign.png')
                              .writeAsBytes(driverBytes);
                          ...
                          bloc.add(
                            ShipmentVerificationEvent.deliveryConfirmEvent(
                              ...
                              sentReturnData: (widget
                                  ...
                                  [],
                              orderIssueReturnId:
                                  widget.args?[AppStrings.orderIssueReturnId],
                ...
                child: Material(
                  ...
                  child: Container(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Text(
                        AppLocalizations.of(context)
                                ?.order_confirmation_loader_text ??
                            'Loading...',
                        style: TextStyle(
                            color: AppColors.blackColor,
                            fontSize: AppConstants.font_14,
                      ...
                      6.height,
                      Text(
                        AppLocalizations.of(context)?.please_wait_text ??
                            'Please wait...',
                        style: TextStyle(
                            fontSize: AppConstants.font_14,
