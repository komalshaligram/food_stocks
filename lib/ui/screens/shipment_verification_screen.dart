  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: ShipmentVerificationScreenWidget(
          args: args, status: args?[AppStrings.deliveryStatusString], isBasket: args?[AppStrings.isFromBasketScreen]),
    );
  }
}
...
class _ShipmentVerificationScreenWidgetState extends State<ShipmentVerificationScreenWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ShipmentVerificationBloc, ShipmentVerificationState>(builder: (context, state) {
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ...
                            Text(formatNumber(value: widget.args?[AppStrings.totalAmountString] ?? '0', local: AppStrings.hebrewLocal),
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Stack(children: [
                        Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          5.height,
                          CustomContainerWidget(name: AppLocalizations.of(context)!.pallets_return, star: '*'),
                          CustomFormField(
                              context: context,
                          ...
                          8.height,
                          CustomContainerWidget(name: AppLocalizations.of(context)!.driver_name, star: '*'),
                          CustomFormField(
                              context: context,
                              fillColor: AppColors.whiteColor,
                                    ...
                                    GestureDetector(
                                      ...
                                      child: SvgPicture.asset(
                                        ...
                                        colorFilter: ColorFilter.mode(
                                            state.isSignaturePadActive ? AppColors.mainColor : AppColors.blackColor, BlendMode.srcIn),
                                      ),
                                    ),
                                    GestureDetector(
                                      onTap: () async {
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: AppConstants.padding_5, horizontal: 0),
                            child: Text(AppLocalizations.of(context)!.driver_signature,
                                style: AppStyles.rkRegularTextStyle(size: AppConstants.smallFont, color: AppColors.blackColor)),
                          ),
                          SizedBox(
                            height: getScreenHeight(context) / 4.5,
                        ...
                        : () async {
                            ...
                            if (!isSign) {
                              CustomSnackBar.showSnackBar(
                                  context: context, title: AppLocalizations.of(context)!.signature_missing, type: SnackBarType.failure);
                              return;
                            }

                            if (!isDriverSign) {
                              CustomSnackBar.showSnackBar(
                                  context: context, title: AppLocalizations.of(context)!.driver_signature_missing, type: SnackBarType.failure);
                            ...
                            bloc.add(ShipmentVerificationEvent.deliveryConfirmEvent(
                                ...
                                sentReturnData: (widget.args?[AppStrings.sentReturnData] as List<dynamic>?)
                ...
                child: Material(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        boxShadow: const [BoxShadow(color: Colors.black26, blurRadius: AppConstants.radius_10, offset: Offset(0, 4))]),
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      SizedBox(height: 80, width: 80, child: Lottie.asset('assets/images/order_confirmation.json', fit: BoxFit.contain)),
                      12.height,
                      Text(AppLocalizations.of(context)?.order_confirmation_loader_text ?? 'Loading...',
                          style: TextStyle(color: AppColors.blackColor, fontSize: AppConstants.font_14, fontWeight: FontWeight.bold),
                          textAlign: TextAlign.center),
                      6.height,
                      Text(AppLocalizations.of(context)?.please_wait_text ?? 'Please wait...',
                          style: TextStyle(fontSize: AppConstants.font_14, color: AppColors.greyColor), textAlign: TextAlign.center),
                      8.height
                    ]),
                  ),
                ),
