...
class SupplierProductsScreenWidget extends StatelessWidget {
      ...
      child: BlocBuilder<SupplierProductsBloc, SupplierProductsState>(
        ...
        return Scaffold(
          ...
          body: FocusDetector(
            onFocusGained: () {
              bloc.add(
                  SupplierProductsEvent.getPermissionList(context: context));
            },
            child: SafeArea(
  ...
  void handleIncrease(
      BuildContext context, SupplierProductsState state, int index) {
    ...
    if (minQty <= quantity + 1) {
      context
          .read<SupplierProductsBloc>()
          .add(SupplierProductsEvent.increaseListQuantityOfProduct(
            context: context,
            productListIndex: 1,
      ...
      context
          .read<SupplierProductsBloc>()
          .add(SupplierProductsEvent.addToCartListProductEvent(
            context: context,
  ...
  void handleDecrease(
    ...
    if (minQty <= quantity - 1) {
      context
          .read<SupplierProductsBloc>()
          .add(SupplierProductsEvent.decreaseListQuantityOfProduct(
            context: context,
            productListIndex: 1,
            productStockUpdateIndex: index,
            productSupplierIds: state.productList[index].supplierId.toString(),
  ...
  Widget gridViewWidget(BuildContext context, SupplierProductsState state) =>
      GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return CommonProductSaleItemWidget(
                ...
                onQuantityChanged: () {
                  context
                      .read<SupplierProductsBloc>()
                      .add(SupplierProductsEvent.updateListQuantityOfProduct(
                        context: context,
  ...
  Widget listViewWidget(BuildContext context, SupplierProductsState state) =>
      ListView.builder(
          itemCount: state.productList.length,
          shrinkWrap: true,
          physics: const NeverScrollableScrollPhysics(),
  ...
  Widget searchWidget(BuildContext context, SupplierProductsBloc bloc,
                      ...
                      itemBuilder: (listViewContext, index) {
                        return SearchItemWidget(
                            ...
                            onTap: () async {
                              ...
                              bloc.add(const SupplierProductsEvent
  ...
  void showProductDetails({
    ...
    context
        .read<SupplierProductsBloc>()
        .add(SupplierProductsEvent.getProductDetailsEvent(
          context: context,
          productId: productId,
            ...
            child: DraggableScrollableSheet(
                ...
                builder:
                  ...
                  return BlocProvider.value(
                    ...
                    child: BlocBuilder<SupplierProductsBloc,
                        SupplierProductsState>(builder: (blocContext, state) {
                      return Container(
                        decoration: BoxDecoration(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context2, i) {
                return CommonProductSaleItemWidget(
                    ...
                    isGuestUser:
                        context.read<SupplierProductsBloc>().state.isGuestUser,
                    onGuestLoginRequired: () => Navigator.pushNamed(
                        context, RouteDefine.connectScreen.name),
                    height: AppConstants.salesProductItemHeight,
        ...
        child: BlocBuilder<SupplierProductsBloc, SupplierProductsState>(
          ...
          return CustomDialog(
              ...
              negativeOnTap: () async {
                ...
                bloc.add(SupplierProductsEvent.addToCartProductEvent(
                    context: context, productId: productId));
              },
              positiveOnTap: () async {
                Navigator.pop(context);
                bloc.add(
                    SupplierProductsEvent.getCartCountEvent(context: context));
              });
        }),
      ),
    );
