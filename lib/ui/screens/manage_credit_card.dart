                                ...
                                child: Column(mainAxisSize: MainAxisSize.min, children: [
                                  Container(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                      Align(alignment: Alignment.centerRight, child: Image.asset(AppImagePath.chipIcon, height: 50, width: 50, color: AppColors.mainColor)),
                                      8.height,
                                  ...
                                  7.height,
                                  ContainerWidget(name: AppLocalizations.of(context)!.validity),
                                  CustomFormField(
                                    context: context,
