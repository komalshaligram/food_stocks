    ...
    return Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
            height: 64,
            width: 64,
            decoration: BoxDecoration(color: AppColors.mainColor.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(18)),
            child: Icon(Icons.credit_card_outlined, size: 32, color: AppColors.mainColor)),
        20.height,
        Text(l10n.credit_card_not_found,
  ...
  Widget _buildCreditCardPreview(ManageCreditCardState state) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: AppColors.mainColor.withValues(alpha: 0.25), blurRadius: 20, offset: const Offset(0, 8))]),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Align(
            alignment: AlignmentDirectional.centerEnd,
            child: Image.asset(AppImagePath.chipIcon, height: 44, width: 44, color: AppColors.whiteColor.withValues(alpha: 0.9))),
        16.height,
        Text(state.creditCardNumberController.text, style: AppStyles.rkBoldTextStyle(size: AppConstants.font_22, color: AppColors.whiteColor)),
        12.height,
        Text(state.validityController.text,
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: state.isDeleteLoading
              ? SizedBox(height: 22, width: 22, child: CircularProgressIndicator(strokeWidth: 2, color: AppColors.redColor.withValues(alpha: 0.75)))
              : Text(l10n.delete_credit_card,
                  style: AppStyles.rkRegularTextStyle(
