...
class SubUserScreenWidget extends StatelessWidget {
      ...
      return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: CommonAppBar(
            ...
            trailingWidget: !state.isShimmering
                ? CustomButtonWidget(
        ...
        body: FocusDetector(
          ...
          child: SafeArea(
            child: SmartRefresher(
              ...
              footer: CustomFooter(builder: (context, mode) => const OrderSummaryScreenShimmerWidget(containerHeight: 40, itemCount: 10)),
  ...
  Widget subUserTiles({required title, required void Function() onTap, required phoneNumber}) {
    return Container(
        ...
        child: Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(phoneNumber, style: AppStyles.rkRegularTextStyle(size: AppConstants.smallFont, color: AppColors.blackColor)),
            ]),
            Icon(Icons.arrow_forward_ios, size: AppConstants.smallFont, color: AppColors.blackColor),
          ]),
        ),
      ),
    );
