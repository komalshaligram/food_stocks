...
class _WalletScreenWidgetState extends State<WalletScreenWidget> with SingleTickerProviderStateMixin {
                    ...
                    onNotification: (notification) {
                      if (notification.metrics.pixels == notification.metrics.maxScrollExtent) {
                        if ((state.balanceSheetList.metaData?.totalFilteredCount ?? 1) > state.walletTransactionsList.length) {
                          context
                              .read<WalletBloc>()
                              .add(WalletEvent.getAllWalletTransactionEvent(context: context, startDate: startDate, endDate: endDate));
                        } else {
                          return false;
                        }
                      }
  ...
  Widget _buildPageHeader(BuildContext context) {
    return Padding(
      ...
      child: Row(children: [
        Expanded(
          child:
              Text(AppLocalizations.of(context)!.wallet, style: AppStyles.rkBoldTextStyle(size: AppConstants.font_20, color: AppColors.blackColor)),
        ),
        Container(
            height: 40,
            width: 40,
          ...
          Expanded(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
              ...
              Directionality(
                ...
                child: Text(formatNumberForWallet(value: state.balance.toString(), local: AppStrings.hebrewLocal, context: context),
                    style: AppStyles.rkBoldTextStyle(size: AppConstants.font_15, color: AppColors.blackColor), textAlign: TextAlign.center),
              ),
            ]),
          ),
          8.width,
              ...
              Row(children: [
                ...
                Flexible(
                  child: DashBoardStatsWidget(
                      ...
                      value:
                          formatNumberForWallet(value: state.lastMonthExpense.toStringAsFixed(0), local: AppStrings.hebrewLocal, context: context)),
                ),
              ]),
            ]),
          ),
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text(AppLocalizations.of(context)!.monthly_expense_graph,
                                ...
                                return Padding(
                                  ...
                                  child: Text(month.toString(),
                                      style: AppStyles.rkRegularTextStyle(
                                          size: AppConstants.font_8, color: AppColors.blackColor.withValues(alpha: 0.45))),
                                );
                              })),
                        ),
                        ...
                        topTitles: AxisTitles(
                          sideTitles: SideTitles(
                              ...
                              getTitlesWidget: ((value, meta) {
                                ...
                                return Text(month.toString() == "0.00" ? '0' : month.toString(),
                                    style:
  ...
  Widget _buildHistorySection(BuildContext context, WalletState state, WalletBloc bloc) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: _horizontalPadding),
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        Text(AppLocalizations.of(context)!.history, style: AppStyles.rkBoldTextStyle(size: AppConstants.font_15, color: AppColors.blackColor)),
        12.height,
        Row(children: [
          Material(
            ...
            child: InkWell(
              onTap: () async {
                ...
                if (state.walletTransactionsList.isNotEmpty) {
                  bloc.add(WalletEvent.exportWalletTransactionEvent(
                      context: context, startDate: startDate ?? state.firstDateOfMonth, endDate: endDate ?? DateTime.now()));
                }
              },
              ...
              child: Container(
                ...
                decoration: BoxDecoration(gradient: AppColors.appMainGradientColor, borderRadius: BorderRadius.circular(14)),
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(12), border: Border.all(color: AppColors.lightBorderColor), color: AppColors.whiteColor),
  ...
  Widget _buildTransactionList(BuildContext context, WalletState state) {
    if (state.isShimmering) {
      return const Padding(padding: EdgeInsets.symmetric(horizontal: _horizontalPadding), child: OrderSummaryScreenShimmerWidget());
    }
          ...
          return Padding(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(color: AppColors.whiteColor, borderRadius: BorderRadius.circular(14), boxShadow: [
                  BoxShadow(color: AppColors.shadowColor.withValues(alpha: 0.06), blurRadius: 12, offset: const Offset(0, 2)),
                ]),
  ...
  Widget dropDownWidget({required int date, required List<int> dateList, required BuildContext context1}) {
    ...
    return Container(
      ...
      decoration:
          BoxDecoration(borderRadius: BorderRadius.circular(10), border: Border.all(color: AppColors.lightBorderColor), color: AppColors.pageColor),
      child: DropdownButton<int>(
          ...
          items: dateList.map((e) {
            return DropdownMenuItem<int>(
                value: e, child: Text(e.toString(), style: AppStyles.rkRegularTextStyle(size: AppConstants.font_13, fontWeight: FontWeight.w500)));
          }).toList(),
          onChanged: (value) {
      ...
      return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(_formatTransactionTime(transaction.createdAt),
