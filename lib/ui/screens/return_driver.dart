...
class _ReturnDriverScreenWidgetState extends State<ReturnDriverScreenWidget> {
        ...
        child: Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(
                width: MediaQuery.of(context).size.width > 370 ? MediaQuery.of(context).size.width / 2 : 160,
                child: Text('$totalUnit ${AppLocalizations.of(context)!.units}', style: AppStyles.rkRegularTextStyle(color: AppColors.blackColor, size: AppConstants.font_12)),
              ),
              SizedBox(
                width: MediaQuery.of(context).size.width > 370 ? MediaQuery.of(context).size.width / 2 : 160,
                child: Text(formatDate(createdAt.toString()), style: AppStyles.rkRegularTextStyle(color: AppColors.blackColor, size: AppConstants.font_12)),
              ),
              3.height,
            ]),
            10.width,
                  ...
                  onTap: () async {
                    ...
                    showDialog(
                      ...
                      builder: (context2) => CommonAlertDialog(
                          ...
                          positiveOnTap: () async {
                            context.read<ReturnDriverBloc>().add(ReturnDriverEvent.deleteProofFileEvent(context: context, index: index, fileIndex: imageIndex));
                            Navigator.pop(context2);
                          }),
                    );
                  })
  ...
  cameraDriverProofEvent({required BuildContext context, required int index, required int imageIndex, required Map<int, Map<String, dynamic>> productIssueData}) async {
    ...
    context.read<ReturnDriverBloc>().add(ReturnDriverEvent.pickProofDocumentEvent(context: context, isFromCamera: true, value: imageIndex, index: index));
  }
