...
class ReturnDriverScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        ...
        child: ReturnDriverScreenWidget(orderId: orderId, orderNumber: orderNumber, statusList: statusList));
  }
}
...
class ReturnDriverScreenWidget extends StatefulWidget {
  ...
  final String orderNumber;
  final List<StatusData> statusList;
  const ReturnDriverScreenWidget({super.key, required this.orderId, required this.orderNumber, required this.statusList});

  @override
  State<ReturnDriverScreenWidget> createState() => _ReturnDriverScreenWidgetState();
}
...
class _ReturnDriverScreenWidgetState extends State<ReturnDriverScreenWidget> {
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(AppLocalizations.of(context)!.return_products_list,
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(AppLocalizations.of(context)!.check_all,
                                            style: AppStyles.rkRegularTextStyle(
                                                size: AppConstants.font_14, color: state.isAllCheck ? AppColors.whiteColor : AppColors.blackColor)),
                                      ),
                                    ),
                                  ]),
                                ),
                                    ...
                                    itemBuilder: (context, dataIndex) {
                                      ...
                                      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        Row(children: [
                                          ...
                                          Text('${AppLocalizations.of(context)!.return_number_text} ${returnDataItem.returnNumber}',
                                        ...
                                        if (isChecked) ...[
                                          Padding(
                                            ...
                                            child: Text(AppLocalizations.of(context)!.driver_return_delivery_document_img,
                                              ...
                                              child: Row(
                                                children: List.generate(3, (imageIndex) {
                                                  final List<File?> files =
                                                      List<File?>.from(state.driverDeliveryProofFilesMap[dataIndex] ?? List.filled(3, null));
                                                      ...
                                                      onTap: () {
                                                        if (file != null) {
                                                          ...
                                                          cameraDriverProofEvent(
                                                              context: context, index: dataIndex, imageIndex: imageIndex, productIssueData: {});
                                                        }
                                                      },
                                                      child: Container(
                                                          height: 120,
                                                          ...
                                                          child:
                                                              file != null ? Image.file(file, fit: BoxFit.cover) : const Icon(Icons.add, size: 50)),
                                                    ),
                                                  );
                                                }),
                                              ),
                  ...
                  child: CustomButtonWidget(
                      onPressed: () {
                        ...
                        checkedItems.forEach((index, isChecked) {
                          if (isChecked) {
                            final returnDataItem = state.returnDriverData.data?[index];
  ...
  Widget productListItem({String? productName, String? productImage, int? totalUnit, String? createdAt, int? index}) {
    return Container(
        ...
        builder: (context1) => Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                FileSelectionOptionWidget(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      cameraDriverProofEvent(context: context, index: index, imageIndex: imageIndex, productIssueData: productIssueData);
                    }),
                file.existsSync()
                    ? FileSelectionOptionWidget(
                        ...
                        onTap: () async {
                          ...
                          showDialog(
                              ...
                              builder: (context2) => CommonAlertDialog(
                                  ...
                                  positiveOnTap: () async {
                                    context
                                        .read<ReturnDriverBloc>()
                                        .add(ReturnDriverEvent.deleteProofFileEvent(context: context, index: index, fileIndex: imageIndex));
                                    Navigator.pop(context2);
                                  }));
                        })
  ...
  cameraDriverProofEvent(
      {required BuildContext context, required int index, required int imageIndex, required Map<int, Map<String, dynamic>> productIssueData}) async {
    ...
    context
        .read<ReturnDriverBloc>()
        .add(ReturnDriverEvent.pickProofDocumentEvent(context: context, isFromCamera: true, value: imageIndex, index: index));
  }
