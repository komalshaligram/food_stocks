    ...
    return BlocProvider(
        create: (context) => OrderSuccessfulBloc()
          ..add(OrderSuccessfulEvent.getDataEvent(
              context: context, showPreviousBtn: args?[AppStrings.showPreviousBtn] ?? false, totalSupplier: args?[AppStrings.totalSupplier]))
    ...
    return BlocBuilder<OrderSuccessfulBloc, OrderSuccessfulState>(builder: (context, state) {
      return WillPopScope(
        ...
        child: Scaffold(
          ...
          body: FocusDetector(
            onFocusGained: () {
              OrderSuccessfulBloc().add(OrderSuccessfulEvent.generalSettings(context: context));
            },
            child: SafeArea(
              child: Stack(children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                      Container(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                          ...
                          Text(AppLocalizations.of(context)!.order_sent_successfully,
                              style:
                                  AppStyles.rkRegularTextStyle(size: AppConstants.font_22, color: AppColors.blackColor, fontWeight: FontWeight.w700)),
                          70.height,
                          Container(
                            padding: const EdgeInsets.symmetric(horizontal: AppConstants.padding_20),
                            child: Text(context.read<OrderSuccessfulBloc>().message,
                                style: AppStyles.rkRegularTextStyle(
                                    size: AppConstants.font_17, color: AppColors.greyColor, fontWeight: FontWeight.normal)),
                          ),
                          50.height
                        ]),
                      ),
                      ...
                      state.seePreviousBtn
                          ? GestureDetector(
                              onTap: () {
                                context.read<OrderSuccessfulBloc>().add(OrderSuccessfulEvent.goToOrderEvent(context: context));
                              },
                              child: Container(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(AppConstants.radius_40), color: AppColors.whiteColor),
                                  child: Container(
                                    padding: const EdgeInsets.all(AppConstants.padding_10),
                                    height: AppConstants.containerHeight_60,
                                    alignment: Alignment.center,
                                    decoration:
                                        BoxDecoration(color: AppColors.navSelectedColor, borderRadius: BorderRadius.circular(AppConstants.radius_40)),
                                    child: Text(AppLocalizations.of(context)!.back_to_order,
                ...
                SizedBox.expand(
                  child: Visibility(
                      ...
                      child: IgnorePointer(child: Confetti(isStopped: !state.duringCelebration, snippingCount: 200, snipSize: 7.0))),
                ),
              ]),
            ),
          ),
