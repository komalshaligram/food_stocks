  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => OrderSuccessfulBloc()
        ..add(OrderSuccessfulEvent.getDataEvent(context: context, showPreviousBtn: args?[AppStrings.showPreviousBtn] ?? false, totalSupplier: args?[AppStrings.totalSupplier]))
                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                decoration: BoxDecoration(color: AppColors.navSelectedColor, borderRadius: BorderRadius.circular(AppConstants.radius_40)),
                                child: Text(AppLocalizations.of(context)!.back_to_home_page, style: AppStyles.rkRegularTextStyle(size: AppConstants.normalFont, color: AppColors.whiteColor)),
                              ),
                            ),
                          )),
                    ]),
