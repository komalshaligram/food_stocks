...
class RegistrationSuccessScreenWidget extends StatefulWidget {
  ...
  @override
  State<RegistrationSuccessScreenWidget> createState() =>
      _RegistrationSuccessScreenWidgetState();
}

class _RegistrationSuccessScreenWidgetState
    extends State<RegistrationSuccessScreenWidget> {
    ...
    return BlocBuilder<RegistrationSuccessBloc, RegistrationSuccessState>(
      ...
      return WillPopScope(
        ...
        child: Scaffold(
          ...
          body: FocusDetector(
            onFocusGained: () {
              RegistrationSuccessBloc().add(
                  RegistrationSuccessEvent.generalSettings(context: context));
            },
            child: SafeArea(
