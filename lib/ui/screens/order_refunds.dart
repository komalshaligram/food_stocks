...
class RefundInvoiceCard extends StatelessWidget {
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (invoice.invoiceNumber?.isNotEmpty ?? false)
          _clickableUnderlinedText(
              ...
              onTap: () => Navigator.pushNamed(context, RouteDefine.refundPdfScreen.name,
                        ...
                        PageRouteBuilder(
                            ...
                            transitionsBuilder: (_, animation, __, child) {
                              ...
                              return SlideTransition(
                                  position: animation.drive(Tween(begin: begin, end: end).chain(CurveTween(curve: curve))), child: child);
                            }));
                  }));
        });
  }
  ...
  Widget _buildTotalRefundRow(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _valueText(context, formatSignedNumber(invoice.totalAmount.toString()))
      ]),
      Padding(
  ...
  Widget _sectionTitle(BuildContext context, String title) =>
      Padding(padding: const EdgeInsets.only(top: AppConstants.padding_4, bottom: AppConstants.padding_6), child: titleText(context, title));
  ...
  Widget _refundEntryRow(
      {required BuildContext context, required String label, required String amount, required String status, required VoidCallback onLabelTap}) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
      _clickableUnderlinedText(context: context, text: label, onTap: onLabelTap),
      Expanded(flex: 2, child: titleGreenText(context, formatSignedNumber(amount), TextDirection.ltr)),
