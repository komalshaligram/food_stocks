  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => InvoiceBloc()
        ..add(InvoiceEvent.getInvoicesDataEvent(context: context)),
      ...
      return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: CommonAppBar(
            ...
            title: context.read<InvoiceBloc>().screenTitleName ==
        ...
        body: SafeArea(
          ...
          child: SmartRefresher(
            ...
            onRefresh: () {
              context
                  .read<InvoiceBloc>()
                  .add(InvoiceEvent.refreshListEvent(context: context));
            },
            onLoading: () {
              context
                  .read<InvoiceBloc>()
                ...
                : !state.isShimmering && state.invoiceDetailsList.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) => invoiceList(
                          ...
                          context: context,
                          invoiceType: state
                              .invoiceDetailsList[index].invoiceType
                              .toString(),
                          invoiceDate: state
                              .invoiceDetailsList[index].invoiceDate
                              .toString(),
                          invoicePrice: state
                          ...
                          invoiceStatus: state.statusList.isNotEmpty
                              ? getStatus(
                                      state.statusList,
                                      state.invoiceDetailsList[index]
                                          .paymentStatus
                                          .toString(),
                                      state.language)
                                  .toCapitalized()
                              : '',
                          supplierName:
                              state.invoiceDetailsList[index].supplierName ??
                                  '',
                          dueDate: state.invoiceDetailsList[index].dueDate
                              .toString(),
                        ),
                      ),
          ),
        ...
        Navigator.pushNamed(
          ...
          arguments: {
            ...
            AppStrings.invoiceTitleNameString:
                context.read<InvoiceBloc>().screenTitleName ==
                        AppLocalizations.of(context)!.my_invoices
                    ? AppLocalizations.of(context)!.my_invoices
                    : AppLocalizations.of(context)!.my_refunds,
          },
