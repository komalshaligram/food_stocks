...
class InvoiceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => InvoiceBloc()..add(InvoiceEvent.getInvoicesDataEvent(context: context)), child: const InvoiceScreenWidget());
  }
}
      ...
      return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: CommonAppBar(
              ...
              title: context.read<InvoiceBloc>().screenTitleName == AppLocalizations.of(context)!.my_invoices
