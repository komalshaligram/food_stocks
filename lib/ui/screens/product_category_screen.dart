                  ...
                  child: Column(children: [
                    state.isShimmering
                        ...
                        : state.productCategoryList.isEmpty
                            ? noDataWithEmpty(AppLocalizations.of(context)!.categories_not_available, context)
                            : GridView.builder(
                                shrinkWrap: true,
      ...
      child: InkWell(
        ...
        child: Column(children: [
          Expanded(
            child: ClipRRect(
              borderRadius:
                  const BorderRadius.only(topLeft: Radius.circular(AppConstants.radius_10), topRight: Radius.circular(AppConstants.radius_10)),
              child: Image.network("${AppUrlEndPoints.baseFileUrl}$categoryImage", fit: BoxFit.cover, alignment: Alignment.center,
