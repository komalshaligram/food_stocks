...
class FileUploadScreenWidget extends StatelessWidget {
                                      ...
                                      : () {
                                          if (state.formsAndFilesList[1].url != null) {
                                            ...
                                            CustomSnackBar.showSnackBar(
                                                context: context, title: AppLocalizations.of(context)!.upload_document, type: SnackBarType.failure);
                                          }
                                        },
                    ...
                    child: Center(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [BoxShadow(color: AppColors.shadowColor.withValues(alpha: 0.1), blurRadius: 20, offset: const Offset(0, 4))]),
                    ...
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                              text: ' *',
                              style:
                                  AppStyles.rkRegularTextStyle(color: AppColors.redColor, size: AppConstants.font_14, fontWeight: FontWeight.w500)),
                        ]),
                  )
                : Text(fileName.toTitleCase(),
                    style: AppStyles.rkRegularTextStyle(
    ...
    if (isRegisterString != true) {
      ...
      if (isForm && url.isNotEmpty) {
        Navigator.pushNamed(context, RouteDefine.previewScreen.name,
            arguments: {AppStrings.privacyPolicyPdfString: url, AppStrings.clientFormString: fileName});
      }
      return;
    }
                    ...
                    onTap: () async {
                      ...
                      if (Platform.isAndroid) {
                        if (!statuses[Permission.camera]!.isGranted) {
                          ...
                          CustomSnackBar.showSnackBar(
                              context: context, title: AppLocalizations.of(context)!.camera_permission, type: SnackBarType.failure);
                          return;
                        }
                      }
                      context
                          .read<FileUploadBloc>()
                          .add(FileUploadEvent.pickDocumentEvent(context: context, isFromCamera: true, fileIndex: fileIndex, isDocument: false));
                      Navigator.pop(context1);
                    }),
                FileSelectionOptionWidget(
                    ...
                    onTap: () async {
                      ...
                      context
                          .read<FileUploadBloc>()
                          .add(FileUploadEvent.pickDocumentEvent(context: context, isFromCamera: false, fileIndex: fileIndex, isDocument: false));
                      Navigator.pop(context1);
                    }),
                FileSelectionOptionWidget(
                    ...
                    onTap: () async {
                      ...
                      context
                          .read<FileUploadBloc>()
                          .add(FileUploadEvent.pickDocumentEvent(context: context, isFromCamera: false, fileIndex: fileIndex, isDocument: true));
                      Navigator.pop(context1);
                    }),
                if (url.isNotEmpty)
                  FileSelectionOptionWidget(
  ...
  Widget _buildUploadContent(
    ...
    if ((isUploading && uploadIndex == fileIndex) || (isRemoveProcess && uploadIndex == fileIndex)) {
      return SizedBox(height: 150, width: double.infinity, child: Center(child: CupertinoActivityIndicator(color: AppColors.mainColor)));
    }
    ...
    if (url.isNotEmpty) {
        ...
        return SizedBox(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Padding(
              ...
              child: Text("${url.split('.').first.split('/').last}.${url.split('.').last}",
      ...
      return !updateState
          ? _buildFullWidthImage(Image.file(File(localUrl), width: double.infinity, fit: BoxFit.fitWidth, alignment: Alignment.topCenter))
          : _buildFullWidthImage(CachedNetworkImage(
    ...
    return SizedBox(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
            height: 48,
            width: 48,
            decoration: BoxDecoration(color: AppColors.mainColor.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(14)),
