...
List<InlineSpan> buildFirstSupplierOrderMessageSpans({
  required String template,
  required String supplierDisplayName,
}) {
  const placeholder = supplierNamePlaceholder;
  final baseStyle = AppStyles.rkRegularTextStyle(
    ...
    if (i < parts.length - 1) {
      spans.add(
        WidgetSpan(
          ...
          child: _SupplierNameHighlight(name: supplierDisplayName),
        ),
      );
    }
  }
    ...
    children: [
      for (var i = 0; i < paragraphs.length; i++) ...[
        ...
        RichText(
          ...
          text: TextSpan(
            children: buildFirstSupplierOrderMessageSpans(
              template: paragraphs[i],
...
class FirstSupplierOrderDialog extends StatelessWidget {
  ...
  const FirstSupplierOrderDialog({
    super.key,
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                20.height,
                buildFirstSupplierOrderMessageContent(
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Icon(Icons.close, size: 28, color: AppColors.blackColor),
            ),
          ),
        ],
      ),
