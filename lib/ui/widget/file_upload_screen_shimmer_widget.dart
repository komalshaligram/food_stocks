...
class FileUploadScreenShimmerWidget extends StatelessWidget {
  ...
  Widget buildFileOrForm() {
    return _buildCard(
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [buildTextFieldTitle(), buildDownloadButton()]),
      12.height,
      CommonShimmerWidget(
        child: Container(
            height: 150, width: double.maxFinite, decoration: BoxDecoration(color: AppColors.pageColor, borderRadius: BorderRadius.circular(12))),
      ),
    ]));
  }
  ...
  Widget buildDownloadButton() {
    return CommonShimmerWidget(
      child: Container(height: 30, width: 90, decoration: BoxDecoration(color: AppColors.pageColor, borderRadius: BorderRadius.circular(10))),
    );
  }
