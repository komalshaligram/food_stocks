...
threeOptionPaymentDialog(BuildContext context, BasketSummaryState state,
    BasketSummaryBloc bloc, BuildContext context1) {
  return CustomOneButtonDialog(
      ...
      if (state.isPaymentFail &&
          state.errorString !=
              AppStrings.getLocalizedStrings(
                  AppLocalizations.of(context)!.credit_card_not_found,
                  context)) {
    ...
    positiveTitle1: state.paymentTypesList.any((e) => e == AppStrings.wallet)
        ? AppLocalizations.of(context)!.change_to_wallet_payment
        : null,
    positiveTitle2:
