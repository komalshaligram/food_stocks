      ...
      isShowSearchLabel
          ? Padding(
              padding: const EdgeInsets.only(
                  left: AppConstants.padding_20, right: AppConstants.padding_20, top: AppConstants.padding_15, bottom: AppConstants.padding_5),
      ...
      InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border:
                Border(bottom: (isLastItem ?? false) ? BorderSide.none : BorderSide(color: AppColors.borderColor.withValues(alpha: 0.5), width: 1)),
          ),
            ...
            SizedBox(
                ...
                width: getItemWidth(context) == 190
                    ...
                    : getItemWidth(context) == 160
                        ...
                        : 50,
                child: !isGuestUser
                    ? Image.network('${AppUrlEndPoints.baseFileUrl}$searchImage', fit: BoxFit.scaleDown,
                        ...
                        return searchType == SearchTypes.subCategory
                            ...
                            : SvgPicture.asset(AppImagePath.splashLogo, fit: BoxFit.scaleDown);
                      })
                    : Image.asset(AppImagePath.imageNotAvailable5, fit: BoxFit.cover)),
            10.width,
            Column(
                ...
                children: [
                  ...
                  Row(children: [
                                ...
                                : (productStock == '0' || productStock == '0.0')
                                    ? Text(AppLocalizations.of(context)!.out_of_stock1,
                                        style: AppStyles.rkBoldTextStyle(
                                            size: AppConstants.font_12, color: AppColors.redColor, fontWeight: FontWeight.w400))
                                    : Text(lowStock,
                                        style: AppStyles.rkBoldTextStyle(
                                            size: AppConstants.font_12, color: AppColors.orangeColor, fontWeight: FontWeight.w400)),
                        numberOfUnits != 0
                            ? scaleType == 'מארזים'
                                ? Text('${numberOfUnits.toString()} ${AppLocalizations.of(context)!.unit_in_box}',
                                    style: AppStyles.rkBoldTextStyle(
                                        size: AppConstants.font_12, color: AppColors.blackColor, fontWeight: FontWeight.w400))
                                : Text(
                            ...
                            ? numberOfUnits != 0 && priceOfBox != 0.0
                                ? salePrice != 0.0
                                    ...
                                    : Text(
                                        ...
                                        style: AppStyles.rkBoldTextStyle(
                                            size: AppConstants.font_12, color: AppColors.blueColor, fontWeight: FontWeight.w400))
                                : 0.width
                            : 0.width
                      ]),
                    ),
                    !isGuestUser
                        ? salePrice != 0.0
                            ? Column(children: [
                                Text('${AppLocalizations.of(context)!.currency}${priceOfBox.toString()}',
                                    style:
                                        AppStyles.rkBoldTextStyle(size: AppConstants.font_12, color: AppColors.blueColor, fontWeight: FontWeight.w400)
                                            .copyWith(decoration: TextDecoration.lineThrough)),
                                Text('${AppLocalizations.of(context)!.currency}${salePrice.toString()}',
                                    style:
                                        AppStyles.rkBoldTextStyle(size: AppConstants.font_12, color: AppColors.redColor, fontWeight: FontWeight.w400))
                              ])
                            : !isGuestUser
                                ? priceOfBox != 0.0
                                    ? SizedBox(
                                        width: 60,
                                        child: Text('${AppLocalizations.of(context)!.currency}${priceOfBox.toString()}',
                                            style: AppStyles.rkBoldTextStyle(
                                                size: AppConstants.font_12, color: AppColors.blueColor, fontWeight: FontWeight.w400)),
                                      )
                                    : 0.width
                  ...
                  isSale!
                      ? Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          minQuantity != '0'
                              ? Text('${AppLocalizations.of(context)!.minimumList}: ${minQuantity.toString()}',
                                  style: AppStyles.rkRegularTextStyle(color: AppColors.redColor, size: AppConstants.font_14))
                              : const IgnorePointer(),
                          maxQuantity != '0'
                              ? Text('${AppLocalizations.of(context)!.maximumList}: ${maxQuantity.toString()}',
                                  style: AppStyles.rkRegularTextStyle(color: AppColors.redColor, size: AppConstants.font_14))
                              : const IgnorePointer()
                        ])
                      : const IgnorePointer(),
