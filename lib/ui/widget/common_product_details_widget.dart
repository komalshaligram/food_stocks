...
class CommonProductDetailsWidget extends StatelessWidget {
  ...
  String get _productDescriptionHtml => productDetails.first.productDescription ?? '';
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              ...
              child: _hasProductDescription
                  ? Align(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                            margin: const EdgeInsets.only(left: AppConstants.padding_5),
                            padding: const EdgeInsets.all(AppConstants.padding_5),
                            decoration: BoxDecoration(color: AppColors.mainColor.withValues(alpha: 0.12), shape: BoxShape.circle),
                            child: Icon(Icons.info_outline_rounded, size: 26, color: AppColors.mainColor)),
                      ),
                    )
                  : 0.width,
            ),
            Expanded(
              flex: 4,
              child: Text(productDetails.first.productName ?? '',
                  style: AppStyles.rkBoldTextStyle(size: AppConstants.normalFont, color: AppColors.blackColor, fontWeight: FontWeight.w600),
                  textAlign: TextAlign.center),
            ),
            Expanded(
              child: GestureDetector(
                  onTap: isFromBasketScreen ? onCloseTap : onCloseTap, child: Icon(Icons.close, size: 36, color: AppColors.blackColor)),
            ),
          ]),
          5.height,
          Text(
                ...
                ? Text.rich(
                    TextSpan(
                      text: scaleType == 'Units'
                          ? (isIncludedVat ? '(${AppLocalizations.of(context)?.price_includes_vat}): ' : '')
                          : (isIncludedVat
          ...
          productDetails.first.sale?.saleDescription != ''
              ? Container(
                  ...
                  child: Text("${parse(productDetails.first.sale?.saleDescription).body?.text}",
          ...
          _hasKosher
              ? Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: AppColors.mainColor.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(AppConstants.radius_100)),
                    child: Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [
                      Icon(Icons.verified_rounded, size: 18, color: AppColors.mainColor),
                      5.width,
                      Flexible(
                        child: Text('${AppLocalizations.of(context)!.kosher}: $_kosher',
                            style: AppStyles.rkBoldTextStyle(size: AppConstants.font_13, color: AppColors.mainColor, fontWeight: FontWeight.w600),
                            textAlign: TextAlign.center),
                      ),
                    ]),
                  ),
          ...
          (productDetails.first.isPesach ?? false)
              ? Container(
                  ...
                  child: productDetails.first.nmMashlim != ''
                      ...
                      : Text(AppLocalizations.of(context)!.pesach, style: const TextStyle(fontSize: AppConstants.font_12)))
              : 0.height,
          (productDetails.first.isPesach ?? false) ? 5.height : 0.height,
          ...
          recommendedRetailConsumerPricerOffer != ''
              ? Center(
                  child: Container(
                      ...
                      child: Text(recommendedRetailConsumerPricerOffer!,
                          style: AppStyles.rkRegularTextStyle(size: AppConstants.font_13, color: AppColors.whiteColor), textAlign: TextAlign.center)))
              : const SizedBox(),
                ...
                child: Stack(children: [
                  Padding(
                    padding: const EdgeInsets.only(
                        bottom: AppConstants.padding_10, right: AppConstants.padding_10, left: AppConstants.padding_10, top: AppConstants.padding_10),
                    child: productImages.first.isNotEmpty
                        ? GestureDetector(
                            onTap: imageOnTap,
                            child: Image.network("${AppUrlEndPoints.baseFileUrl}${productImages.first}",
                        ...
                        : Image.asset(AppImagePath.imageNotAvailable5, fit: BoxFit.cover, height: 150),
                  ),
                ]),
              ),
            ),
            Text(productDetails.first.qrcode ?? '', style: AppStyles.rkRegularTextStyle(size: AppConstants.smallFont, color: AppColors.blackColor)),
            5.height,
            Container(
              decoration: BoxDecoration(
                border: Border(
              ...
              child: productStock == '0' || productStock == "-1" || productStock == "0.0"
                  ...
                  : Column(children: [
                        ...
                        SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(
                                ...
                                style:
                                    AppStyles.rkBoldTextStyle(size: AppConstants.font_30, color: AppColors.blackColor, fontWeight: FontWeight.w700)),
                            !isIncludedVat
                                ? (productDetails.first.isBottle ?? false)
                                    ? Container(
                                        padding: const EdgeInsets.only(top: AppConstants.padding_3),
                                        child: Text(
                                ...
                                : 0.width,
                            isIncludedVat
                                ? Text('(${AppLocalizations.of(context)!.price_includes_vat})',
                                    style: AppStyles.rkBoldTextStyle(
                                        size: AppConstants.smallFont, color: AppColors.blackColor, fontWeight: FontWeight.w400))
                                : 0.width,
                          ]),
                        ),
                        SizedBox(
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Container(
                                      ...
                                      child: Icon(Icons.add, size: 26, color: AppColors.mainColor)),
                                ),
                                5.width,
                                Expanded(
                                  child: Container(
                                    ...
                                    alignment: Alignment.center,
                                    child: TextField(
                                      controller: TextEditingController(text: "$productQuantity")
                                        ..selection = TextSelection.fromPosition(TextPosition(offset: "$productQuantity".length)),
                                      textAlign: TextAlign.center,
                                      style: AppStyles.rkBoldTextStyle(
                                          size: AppConstants.font_26, color: AppColors.blackColor, fontWeight: FontWeight.w700),
                                      maxLength: 5,
                                      maxLines: 1,
                      ...
                      if ((productDetails.first.sale?.isSale ?? false) &&
                          ...
                          productDetails.first.sale?.saleMaxQuantity != '100')
                        Column(children: [
                          Container(
                            alignment: Alignment.centerRight,
                            margin: const EdgeInsets.only(top: AppConstants.padding_3),
                            child: Text('${AppLocalizations.of(context)!.minimum_box_title} ${productDetails.first.sale?.saleMinQuantity}',
                                style:
                                    AppStyles.rkBoldTextStyle(size: AppConstants.font_13, color: AppColors.orangeColor, fontWeight: FontWeight.w400)),
                          ),
                          Container(
                            alignment: Alignment.centerRight,
                            margin: const EdgeInsets.only(top: AppConstants.padding_3),
                            child: Text('${AppLocalizations.of(context)!.maximum_qty}: ${productDetails.first.sale?.saleMaxQuantity}',
                                style:
                                    AppStyles.rkBoldTextStyle(size: AppConstants.font_13, color: AppColors.orangeColor, fontWeight: FontWeight.w400)),
                          )
                        ])
                      ...
                      (productDetails.first.supplierSales?.first.lowStock != '') && (productStock != '0' || productStock != '0.0')
                          ? Text((productDetails.first.supplierSales?.first.lowStock.toString() ?? ''),
                      ...
                      isMixedSale!
                          ? Container(
                              ...
                              child: Text(AppLocalizations.of(context)!.mixedSale,
                                  style: AppStyles.rkBoldTextStyle(
                                      size: AppConstants.font_13, color: AppColors.orangeColor, fontWeight: FontWeight.w400)),
                            )
                          : const IgnorePointer(),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(
                          AppConstants.padding_15, AppConstants.padding_15, AppConstants.padding_15, AppConstants.padding_10),
                      child: Row(children: [
                        Container(
                            padding: const EdgeInsets.all(AppConstants.padding_5),
                            decoration: BoxDecoration(color: AppColors.mainColor.withValues(alpha: 0.12), shape: BoxShape.circle),
                            child: Icon(Icons.info_outline_rounded, size: 22, color: AppColors.mainColor)),
                        AppConstants.padding_10.width,
                        Expanded(
                          child: Text(AppLocalizations.of(context)!.product_information,
                              style:
                                  AppStyles.rkBoldTextStyle(size: AppConstants.normalFont, color: AppColors.blackColor, fontWeight: FontWeight.w700)),
                        ),
                        GestureDetector(
                            onTap: () => Navigator.pop(sheetContext),
                            behavior: HitTestBehavior.opaque,
                            child: Icon(Icons.close, size: 28, color: AppColors.greyColor)),
                      ]),
                    ),
                    Padding(
                    ...
                    Padding(
                        ...
                        child: Divider(height: 1, thickness: 1, color: AppColors.borderColor.withValues(alpha: 0.5))),
                    Flexible(
                      child: SingleChildScrollView(
                        controller: controller,
                        padding: const EdgeInsets.fromLTRB(AppConstants.padding_15, 0, AppConstants.padding_15, AppConstants.padding_30),
                        child: Directionality(
                          textDirection: TextDirection.rtl,
                          child: Html(data: _productDescriptionHtml, shrinkWrap: true, style: {
                            "body": Style(
                                margin: Margins.zero,
