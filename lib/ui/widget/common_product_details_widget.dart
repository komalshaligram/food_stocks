              ...
              child: productStock == '0' || productStock == "-1" || productStock == "0.0"
                  ...
                  : Column(children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            !isIncludedVat
                                ? (productDetails.first.isBottle ?? false)
                                    ? Container(
                                        ...
                                        child: Text('${AppLocalizations.of(context)?.bottle_deposit}:${AppLocalizations.of(context)!.currency}${totalBottleDeposit.toStringAsFixed(AppConstants.amountFrLength)}'),
                                      )
                                    : 0.height
                                : 0.width,
                            isIncludedVat
                        ...
                        SizedBox(
                          width: getScreenWidth(context) >= 700 ? (getScreenWidth(context) - 30) / 3 : (getScreenWidth(context) - 30) / 2,
                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.end, mainAxisSize: MainAxisSize.max, children: [
                            GestureDetector(
