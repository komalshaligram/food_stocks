...
/// Bottom sheet for supplier city delivery schedule.
...
class SupplierDeliverySchedulePanel extends StatelessWidget {
  const SupplierDeliverySchedulePanel({
    super.key,
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(
              AppConstants.padding_10,
              showDragHandle ? AppConstants.padding_10 : AppConstants.padding_10,
              AppConstants.padding_10,
              AppConstants.padding_10,
            ),
            ...
            child: Row(
              children: [
                Transform.flip(
                  flipX: true,
                  child: Icon(Icons.local_shipping_outlined, color: AppColors.whiteColor, size: 22),
                ),
                8.width,
                Expanded(
                  child: Text(
...
class _DeliveryDayRow extends StatelessWidget {
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  l10n.supplier_delivery_schedule_order_until,
              ...
              Expanded(
                child: Text(
                  l10n.supplier_delivery_schedule_delivery_on,
                  style: AppStyles.rkRegularTextStyle(
                    size: AppConstants.font_10,
                    color: AppColors.greyColor,
                  ),
  ...
  bool _hasAnyTime(SupplierCityDeliveryDay day) {
    return _formatUntilTime(day.orderUntilTime).isNotEmpty ||
        _formatUntilTime(day.deliveryUntilTime).isNotEmpty;
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: const EdgeInsets.symmetric(
        ...
        vertical: AppConstants.padding_6,
      ),
      decoration: BoxDecoration(
