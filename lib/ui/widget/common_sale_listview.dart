                    ...
                    !isGuestUser
                        ? numberOfUnits != '0'
                            ? Text(
                                ...
                                style:
                                    AppStyles.rkBoldTextStyle(size: AppConstants.font_12, color: AppColors.blackColor, fontWeight: FontWeight.w400))
                            : 0.width
                        : 0.width,
                    1.height,
                  ]),
              ...
              Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                if (salesDesc!.isNotEmpty)
                  Container(
                    ...
                    child: Text("${parse(salesDesc).body?.text}",
                      ...
                      ? (isFromSale == true
                          ? Text.rich(
                              TextSpan(
                                children: <TextSpan>[
                                  TextSpan(
                                      text: '${AppLocalizations.of(context)?.currency}${(price as num).toStringAsFixed(2)} ',
                                      style: AppStyles.rkRegularTextStyle(
                                        size: AppConstants.font_12,
                                        color: AppColors.blackColor,
                                      ).copyWith(decoration: TextDecoration.lineThrough)),
                                  TextSpan(
                                      text: '${AppLocalizations.of(context)?.currency}${discountedPrice.toStringAsFixed(2)}',
