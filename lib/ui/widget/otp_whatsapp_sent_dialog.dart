...
Future<void> showOtpSentViaWhatsappDialog({
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    ...
                    height: 96,
                    decoration: BoxDecoration(
                      color: kWhatsappGreen.withOpacity(0.10),
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [kWhatsappGreen, kWhatsappDarkGreen],
                      ),
                      shape: BoxShape.circle,
                    ),
                    child: const Icon(
            ...
            Text(
              l10n.otp_sent_via_whatsapp_title,
            ...
            Text(
              l10n.otp_sent_via_whatsapp_message,
              textAlign: TextAlign.center,
            ...
            SizedBox(
              ...
              child: MaterialButton(
                ...
                child: Text(
                  l10n.otp_sent_via_whatsapp_action,
                  style: AppStyles.rkBoldTextStyle(
                    size: 16,
                    color: AppColors.whiteColor,
                    fontWeight: FontWeight.w600,
