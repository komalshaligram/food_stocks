...
//
//     final statusInfoResModel = statusInfoResModelFromJson(jsonString);
...
class Data with _$Data {
  const factory Data({
    ...
    List<StatusData>? orderStatus,
    @JsonKey(name: "paymentStatus")
    List<StatusData>? paymentStatus,
    @JsonKey(name: "returnStatus")
    List<StatusData>? returnStatus,
  }) = _Data;
...
class StatusData with _$StatusData {
  const factory StatusData({
    @JsonKey(name: "statusNameKey")
    String? statusNameKey,
    @JsonKey(name: "statusNameEnglish")
    String? statusNameEnglish,
    @JsonKey(name: "statusNameHebrew")
    String? statusNameHebrew,
  ...
  static String encode(List<StatusData> musics) => json.encode(
    musics
        .map<Map<String, dynamic>>((music) => StatusData.toMap(music))
        .toList(),
  );

  static List<StatusData> decode(String musics) =>
      (json.decode(musics) as List<dynamic>)
          .map<StatusData>((item) => StatusData.fromJson(item))
          .toList();
