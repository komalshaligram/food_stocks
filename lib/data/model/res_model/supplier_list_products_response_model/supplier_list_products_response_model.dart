...
class SupplierListProductsResponseModel with _$SupplierListProductsResponseModel {
  const factory SupplierListProductsResponseModel(
      ...
      @JsonKey(name: "message") String? message}) = _SupplierListProductsResponseModel;

  factory SupplierListProductsResponseModel.fromJson(Map<String, dynamic> json) => _$SupplierListProductsResponseModelFromJson(json);
}
...
class SupplierListProductsData with _$SupplierListProductsData {
  const factory SupplierListProductsData(
      ...
      @JsonKey(name: "products") List<ProductData>? products}) = _SupplierListProductsData;

  factory SupplierListProductsData.fromJson(Map<String, dynamic> json) => _$SupplierListProductsDataFromJson(json);
}
...
class SupplierCategoryData with _$SupplierCategoryData {
  const factory SupplierCategoryData(
      ...
      @JsonKey(name: "order") int? order}) = _SupplierCategoryData;

  factory SupplierCategoryData.fromJson(Map<String, dynamic> json) => _$SupplierCategoryDataFromJson(json);
}

@freezed
class SupplierSubCategoryData with _$SupplierSubCategoryData {
  const factory SupplierSubCategoryData({@JsonKey(name: "_id") String? id, @JsonKey(name: "subCategoryName") String? subCategoryName}) =
      _SupplierSubCategoryData;

  factory SupplierSubCategoryData.fromJson(Map<String, dynamic> json) => _$SupplierSubCategoryDataFromJson(json);
}
...
class BrandData with _$BrandData {
  const factory BrandData(
      ...
      @JsonKey(name: "updatedAt") String? updatedAt}) = _BrandData;
...
class ProductData with _$ProductData {
  const factory ProductData(
      ...
      @JsonKey(name: "filtersubCategoryId") String? filtersubCategoryId}) = _ProductData;
...
class Sale with _$Sale {
  const factory Sale(
      ...
      @JsonKey(name: "sameSaleProducts") List<dynamic>? sameSaleProducts}) = _Sale;
...
class MetaData with _$MetaData {
  const factory MetaData(
      ...
      @JsonKey(name: "totalFilteredPage") int? totalFilteredPage}) = _MetaData;
