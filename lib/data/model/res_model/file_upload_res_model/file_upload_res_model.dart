...
FileUploadResModel fileUploadResModelFromJson(String str) => FileUploadResModel.fromJson(json.decode(str));

String fileUploadResModelToJson(FileUploadResModel data) => json.encode(data.toJson());
