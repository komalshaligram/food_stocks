...
ProfileDetailsReqModel profileDetailsReqModelFromJson(String str) => ProfileDetailsReqModel.fromJson(json.decode(str));

String profileDetailsReqModelToJson(ProfileDetailsReqModel data) => json.encode(data.toJson());
