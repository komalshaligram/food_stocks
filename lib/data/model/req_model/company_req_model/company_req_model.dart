...
CompanyReqModel companyReqModelFromJson(String str) => CompanyReqModel.fromJson(json.decode(str));

String companyReqModelToJson(CompanyReqModel data) => json.encode(data.toJson());
