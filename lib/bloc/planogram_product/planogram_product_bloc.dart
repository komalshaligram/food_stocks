...
class PlanogramProductBloc extends Bloc<PlanogramProductEvent, PlanogramProductState> {
  ...
  PlanogramProductBloc() : super(PlanogramProductState.initial()) {
    on<PlanogramProductEvent>((event, emit) async {
      ...
      if (event is _getPlanogramProductsEvent) {
        ...
        add(const PlanogramProductEvent.removeRelatedProductEvent());
            ...
            if (response.product!.isNotEmpty) {
              ...
              if (supplierList.isNotEmpty) {
                ...
                if (!isSupplierSelected || state.productListIndex == 0) {
                  ...
                  add(PlanogramProductEvent.supplierSelectionEvent(supplierIndex: supplierIndex, context: event.context, supplierSaleIndex: supplierSaleIndex));
                }
              }
            } else {
