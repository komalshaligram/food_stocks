...
class RecommendationProductsEvent with _$RecommendationProductsEvent {
  ...
  const factory RecommendationProductsEvent.addToCartProductEvent({required BuildContext context, required String productId}) =
  ...
  const factory RecommendationProductsEvent.updateGlobalSearchEvent({required String search, required List<SearchModel> searchList}) =
  ...
  const factory RecommendationProductsEvent.applyCartQuantitiesEvent({required Map<String, int> cartQuantities}) = _applyCartQuantitiesEvent;
}
