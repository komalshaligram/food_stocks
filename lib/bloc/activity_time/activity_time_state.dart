...
class ActivityTimeState with _$ActivityTimeState {
  const factory ActivityTimeState(
      ...
      required bool isShimmering}) = _ActivityTimeState;

  factory ActivityTimeState.initial() => const ActivityTimeState(
      time: AppStrings.timeString, operationTimeList: [], isRefresh: false, errorMessage: '', isUpdate: false, isLoading: false, isShimmering: false);
}
