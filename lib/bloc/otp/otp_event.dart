...
class OtpEvent with _$OtpEvent {
  ...
  const factory OtpEvent.otpApiEvent({required String contact, required String otp, required bool isRegister, required BuildContext context}) = _otpApiEvent;

  const factory OtpEvent.registerApiEvent({required String contact, required String otp, required bool isRegister, required BuildContext context}) = _registerApiEvent;
