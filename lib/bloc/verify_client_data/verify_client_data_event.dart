...
class VerifyClientDataEvent with _$VerifyClientDataEvent {
  const factory VerifyClientDataEvent.initEvent({
    required BuildContext context,
    String? nextRouteName,
    Map<dynamic, dynamic>? nextRouteArgs,
  }) = _initEvent;
  ...
  const factory VerifyClientDataEvent.pickDeliveryImageEvent({
    required BuildContext context,
    required bool isFromCamera,
  }) = _pickDeliveryImageEvent;
