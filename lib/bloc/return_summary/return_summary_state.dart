...
class ReturnSummaryState with _$ReturnSummaryState {
  factory ReturnSummaryState({required bool isRedirected,
    ...
    required bool isLoading, required String language, required TextEditingController barCodeController}) = _ReturnSummaryState;

  factory ReturnSummaryState.initial() => ReturnSummaryState(supplierWiseMap:{},isRedirected: false,isShimmer:false,
