...
class CreditCardDetailsEvent with _$CreditCardDetailsEvent {
  factory CreditCardDetailsEvent.getArgumentEvent(
      ...
      required MyCardInvoice invoiceData}) = _getArgumentEvent;

  factory CreditCardDetailsEvent.addCreditCardEvent(
      {required BuildContext context, required bool isPaymentToNext, required MyCardInvoice invoiceData}) = _addCreditCardEvent;
