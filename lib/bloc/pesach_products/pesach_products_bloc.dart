      ...
      if (event is _getSupplierProductsListEvent) {
        ...
        try {
          ...
          if (response.status == AppConstants.code_200) {
            ...
            emit(state.copyWith(isBottomOfProducts: productList.length == (response.metaData?.totalFilteredCount ?? 0) ? true : false, isProgress: false));
          } else {
        ...
        emit(state.copyWith(pageNum: 0, isProgress: false, productList: [], productStockList: [state.productStockList[0], [], []], isBottomOfProducts: false));
        if (!state.isProgress) {
            ...
            if (response.product!.isNotEmpty) {
              ...
              if (supplierList.isNotEmpty) {
                ...
                if (!isSupplierSelected || state.productListIndex == 0) {
                  ...
                  add(PesachProductsEvent.supplierSelectionEvent(supplierIndex: supplierIndex, context: event.context, supplierSaleIndex: supplierSaleIndex));
                }
              }
            } else {
