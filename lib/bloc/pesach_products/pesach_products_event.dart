...
class PesachProductsEvent with _$PesachProductsEvent {
  ...
  const factory PesachProductsEvent.changeCategoryExpansion({
    bool? isOpened,
  }) = _changeCategoryExpansion;

  const factory PesachProductsEvent.globalSearchEvent({
    required BuildContext context,
  }) = _globalSearchEvent;
  ...
  const factory PesachProductsEvent.relatedProductsEvent({
    required BuildContext context,
    required String productId,
