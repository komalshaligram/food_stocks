...
class PesachProductsEvent with _$PesachProductsEvent {
  ...
  const factory PesachProductsEvent.getSupplierProductsListEvent({required BuildContext context, required String searchType}) =
  ...
  const factory PesachProductsEvent.updateGlobalSearchEvent({required String search, required List<SearchModel> searchList}) =
  ...
  const factory PesachProductsEvent.applyCartQuantitiesEvent({required Map<String, int> cartQuantities}) = _applyCartQuantitiesEvent;
}
