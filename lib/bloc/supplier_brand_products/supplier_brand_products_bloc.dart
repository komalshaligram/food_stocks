      ...
      if (event is _getPreferencesDataEvent) {
        ...
        try {
          ...
          SupplierBrandProductRequestModel request = SupplierBrandProductRequestModel(
              supplierId: event.supplierId, pageLimit: AppConstants.supplierProductPageLimit, pageNum: state.pageNum + 1, brandId: event.brandId);
        ...
        add(SupplierBrandProductsEvent.getCategoryProductsListEvent(
            context: event.context, supplierId: event.supplierId, categoryId: event.categoryId));
        ...
        if (!state.isProgress) {
          if ((event.categoryId ?? '').isNotEmpty) {
            ...
            add(SupplierBrandProductsEvent.getBrandProductsListEvent(
                context: event.context, supplierId: event.supplierId, brandId: event.brandId ?? ''));
          }
        }
            ...
            if (response.product!.isNotEmpty) {
              ...
              if (supplierList.isNotEmpty) {
                ...
                if (!isSupplierSelected || state.productListIndex == 0) {
                  ...
                  add(SupplierBrandProductsEvent.supplierSelectionEvent(
