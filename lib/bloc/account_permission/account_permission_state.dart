...
class AccountPermissionState with _$AccountPermissionState {
  const factory AccountPermissionState(
      ...
      required String subUserId}) = _AccountPermissionState;

  factory AccountPermissionState.initial() =>
      const AccountPermissionState(isShimmering: false, permissionList: [], isRefresh: false, isUpdateProcess: false, subUserId: '');
}
