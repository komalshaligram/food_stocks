...
class HomeEvent with _$HomeEvent {
  ...
  const factory HomeEvent.getSuppliersDataListEvent(
      {required BuildContext context}) = _getSuppliersDataListEvent;
  ...
  const factory HomeEvent.getProfileDetailsEvent(
      {required BuildContext context}) = _getProfileDetailsEvent;
  ...
  const factory HomeEvent.getCompaniesListEvent(
      {required BuildContext context}) = _getCompaniesListEvent;

  const factory HomeEvent.getPreviousOrderProductsListEvent(
