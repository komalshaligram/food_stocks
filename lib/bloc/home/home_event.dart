...
class HomeEvent with _$HomeEvent {
  ...
  const factory HomeEvent.changeNoteOfProduct({
  ...
  const factory HomeEvent.setMessageCountEvent({
  ...
  const factory HomeEvent.changeCategoryExpansion({
    bool? isOpened,
  }) = _changeCategoryExpansion;

  const factory HomeEvent.globalSearchEvent({
    required BuildContext context,
  }) = _globalSearchEvent;
  ...
  const factory HomeEvent.callAPIEvent({
    required BuildContext context,
  }) = _callAPIEvent;
