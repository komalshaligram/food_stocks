...
class HomeEvent with _$HomeEvent {
  ...
  const factory HomeEvent.updateImageIndexEvent({required int index}) = _updateImageIndexEvent;

  const factory HomeEvent.updateMessageListEvent({required List<String> messageIdList}) = _updateMessageListEvent;

  const factory HomeEvent.toggleNoteEvent({required bool isBarcode}) = _ToggleNoteEvent;
  ...
  const factory HomeEvent.syncCartWithProductStockListEvent({required BuildContext context}) = _syncCartWithProductStockListEvent;
