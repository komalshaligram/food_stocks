...
class CompanyProductsEvent with _$CompanyProductsEvent {
  ...
  const factory CompanyProductsEvent.updateGlobalSearchEvent({required String search, required List<SearchModel> searchList}) =
  ...
  const factory CompanyProductsEvent.applyCartQuantitiesEvent({required Map<String, int> cartQuantities}) = _applyCartQuantitiesEvent;
}
