...
class CompanyProductsEvent with _$CompanyProductsEvent {
  ...
  const factory CompanyProductsEvent.getCompanyProductsIdEvent({required String companyId}) = _getCompanyProductsIdEvent;

  const factory CompanyProductsEvent.getCompanyProductsListEvent({required BuildContext context}) = _getCompanyProductsListEvent;

  const factory CompanyProductsEvent.selectCategoryEvent({required BuildContext context, required String categoryId}) = _selectCategoryEvent;

  const factory CompanyProductsEvent.selectSubCategoryEvent({required BuildContext context, required String subCategoryId}) = _selectSubCategoryEvent;
  ...
  const factory CompanyProductsEvent.increaseQuantityOfProduct({required BuildContext context}) = _increaseQuantityOfProduct;

  const factory CompanyProductsEvent.decreaseQuantityOfProduct({required BuildContext context}) = _decreaseQuantityOfProduct;
  ...
  const factory CompanyProductsEvent.supplierSelectionEvent({required int supplierIndex, required BuildContext context, required int supplierSaleIndex}) = _supplierSelectionEvent;
  ...
  const factory CompanyProductsEvent.changeCategoryExpansion({bool? isOpened}) = _changeCategoryExpansion;

  const factory CompanyProductsEvent.globalSearchEvent({required BuildContext context}) = _globalSearchEvent;

  const factory CompanyProductsEvent.updateGlobalSearchEvent({required String search, required List<SearchModel> searchList}) = _updateGlobalSearchEvent;

  const factory CompanyProductsEvent.getProductCategoriesListEvent({required BuildContext context}) = _getProductCategoriesListEvent;
  ...
  const factory CompanyProductsEvent.getPermissionList({required BuildContext context}) = _getPermissionList;

  const factory CompanyProductsEvent.userApproveEvent({required BuildContext context}) = _userApproveEvent;
  ...
  const factory CompanyProductsEvent.getCartCountNoEvent({required BuildContext context}) = _getCartCountNoEvent;

  const factory CompanyProductsEvent.applyCartQuantitiesEvent({
