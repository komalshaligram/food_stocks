...
class InvoicePaymentEvent with _$InvoicePaymentEvent {
  ...
  factory InvoicePaymentEvent.addCreditCardEvent({required BuildContext context, required int invoiceNumber, required String orderId, required String supplierId}) = _addCreditCardEvent;
}
