...
class MyClientsEvent with _$MyClientsEvent {
  ...
  const factory MyClientsEvent.switchAccountEvent(
      {required BuildContext context, required String clientsId, required String clientName, required String? businessName}) = _switchAccountEvent;

  const factory MyClientsEvent.updateAgentClientsNoMinimumEvent(
      {required BuildContext context,
      required String clientsId,
      required String supplierId,
      required bool isNoMinimum}) = _updateAgentClientsNoMinimumEvent;
