          ...
          try {
            ...
            if (response[AppStrings.statusString] == AppConstants.code_200) {
              ...
              CustomSnackBar.showSnackBar(
                  context: event.context, title: AppLocalizations.of(event.context)!.logged_out_successfully, type: SnackBarType.success);
          ...
          try {
            ...
            if (response.status == AppConstants.code_200) {
              ...
              if (!preferences.getSubUser()) {
                ...
                emit(state.copyWith(
                    showDocumentScanOnApp: preferences.getDocumentScanOnApp(), isCanScanDocuments: preferences.getDocumentScanMenuVisible()));
              }
            } else {
              CustomSnackBar.showSnackBar(
                  context: event.context,
            ...
            try {
              ...
              if (response.status == AppConstants.code_200) {
                ...
                if (preferences.getCanSeeWallet() != res?.canSeeWallet) {
                  event.context
                      .read<BottomNavBloc>()
                      .add(BottomNavEvent.changePage(index: preferences.getCanSeeWallet() ? 4 : 3, context: event.context));
                }
