...
class ReturnDriverEvent with _$ReturnDriverEvent {
  const factory ReturnDriverEvent.getProductDataEvent({required BuildContext context, required String orderId, required OrdersBySupplier orderBySupplierProduct, required OrderDatum orderData}) = _getProductDataEvent;
  ...
  factory ReturnDriverEvent.pickProofDocumentEvent({
    ...
    required int value, required int index,
  }) = _pickProofDocumentEvent;

  factory ReturnDriverEvent.deleteProofFileEvent({
    required int index,
    required BuildContext context, required int fileIndex,
