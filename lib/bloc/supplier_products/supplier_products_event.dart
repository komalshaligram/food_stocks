...
class SupplierProductsEvent with _$SupplierProductsEvent {
  ...
  const factory SupplierProductsEvent.getSupplierProductsListEvent({required BuildContext context, required String searchType}) =
  ...
  const factory SupplierProductsEvent.updateGlobalSearchEvent({required String search, required List<SearchModel> searchList}) =
  ...
  const factory SupplierProductsEvent.applyCartQuantitiesEvent({required Map<String, int> cartQuantities}) = _applyCartQuantitiesEvent;
}
