...
class SupplierProductsEvent with _$SupplierProductsEvent {
  ...
  const factory SupplierProductsEvent.getAllProducts({
    required BuildContext context,
    required String search,
  }) = _getAllProductsEvent;

  const factory SupplierProductsEvent.getGridListView() = _getGridListView;
  const factory SupplierProductsEvent.changeCategoryExpansion({
    bool? isOpened,
  }) = _changeCategoryExpansion;

  const factory SupplierProductsEvent.globalSearchEvent({
    required BuildContext context,
  }) = _globalSearchEvent;
  ...
  const factory SupplierProductsEvent.relatedProductsEvent({
    required BuildContext context,
    required String productId,
