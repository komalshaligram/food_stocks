      ...
      if (event is _getSupplierProductsIdEvent) {
        ...
        try {
          ...
          if (response.status == AppConstants.code_200) {
            ...
            productStockList[1].addAll(stockList);
            try {
              final cartRes = await DioClient(event.context).post('${AppUrlEndPoints.getAllCartUrl}${preferences.getCartId()}');
            ...
            emit(state.copyWith(
                productList: productList, productStockList: productStockList, pageNum: state.pageNum + 1, isShimmering: false, isLoadMore: false));
