...
class SupplierListProductsEvent with _$SupplierListProductsEvent {
  ...
  const factory SupplierListProductsEvent.getSupplierProductsIdEvent({
  ...
  const factory SupplierListProductsEvent.updateQuantityOfProduct({required BuildContext context, required String quantity}) = _updateQuantityOfProduct;
  ...
  const factory SupplierListProductsEvent.updateGlobalSearchEvent({required String search, required List<SearchModel> searchList}) = _updateGlobalSearchEvent;
