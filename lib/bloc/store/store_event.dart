...
class StoreEvent with _$StoreEvent {
  ...
  const factory StoreEvent.getRecommendationProductsListEvent({required BuildContext context}) = _getRecommendationProductsListEvent;
  ...
  const factory StoreEvent.decreaseQuantityOfProduct({required BuildContext context}) = _decreaseQuantityOfProduct;
  ...
  const factory StoreEvent.getPermissionList({required BuildContext context}) = _getPermissionList;
