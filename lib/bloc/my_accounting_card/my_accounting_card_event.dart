...
class MyAccountingCardEvent with _$MyAccountingCardEvent {
  ...
  factory MyAccountingCardEvent.getClientRefundInvoicesFromRivchitDataEvent({required BuildContext context}) =
  ...
  factory MyAccountingCardEvent.updateInvoicesDateRange({required DateTime? from, required DateTime? to, required BuildContext context}) =
      _updateInvoicesDateRange;

  factory MyAccountingCardEvent.updateRefundsDateRange({required DateTime? from, required DateTime? to, required BuildContext context}) =
