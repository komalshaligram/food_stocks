...
class ManageCreditCardEvent with _$ManageCreditCardEvent {
  ...
  factory ManageCreditCardEvent.addCreditCardEvent({required BuildContext context}) =
  _addCreditCardEvent;
  factory ManageCreditCardEvent.deleteCreditCardEvent({required BuildContext context}) =
